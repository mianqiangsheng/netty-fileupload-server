...
public class FileUploadTest {
	...
	public static void main(String[] args) {
		...
		String file2 = "C:\\Users\\86181\\IdeaProjects\\sh-back-end\\target\\EmsWebTpl-1.0-SNAPSHOT.jar";
		String file3 = "C:\\Users\\86181\\Desktop\\AQS示意图.jpg";
...
//		executor.execute(new ClientSenderThread(file5, client, "business_log"));
		clients.add(client2);
		executor.execute(new ClientSenderThread(file2, client2, "business_log"));
